...
#include "Characters/CharacterAnimationSM.h"
	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				//ClientPlayer::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				////
				...
				////
				CharacterAnimationSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				DemoAnimationCharacter::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				CharacterAnimationControler::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				////
			}
			...
			// start root.CharacterControl.Events
			{
				...
				Event_MovePlayer_C_to_S::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_MovePlayer_S_to_C::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				//
				Event_Player_Move::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_Player_Turn::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_Player_Shoot::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_Player_Hurt::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);

				//

				///
				Event_CreateDemoAnimationCharacter::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				///
			}
