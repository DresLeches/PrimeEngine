...
#define NETWORK_CLIENT_CONTROL_DEBUG 0
...
// Used to test the character networking control since soldiers currently don't have static mesh		
#if NETWORK_CLIENT_CONTROL_DEBUG
	...
	//create player controls mimics tank 
	{
		// create the GameObjectmanager addon that is in charge of game objects in this demo
