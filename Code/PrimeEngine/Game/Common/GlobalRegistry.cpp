		...
		// start root.PE
		{
			...
			// start root.PE.Events
			{
				PE::Events::Event::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_KEY_G_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_SPACEBAR_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_MOUSE_LBUTTON_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_MOUSE_ROTATE::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);

					// Networkable Events
					PE::Events::Event_SERVER_CLIENT_CONNECTION_ACK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_SERVER_CLIENT_PLAYER_JOINED::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_SERVER_CLIENT_LOAD_LEVEL::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_CLIENT_SERVER_KILLED::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_SERVER_CLIENT_RESPAWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_SERVER_CLIENT_TAKEDAMAGE::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_CLIENT_SERVER_TAKEDAMAGE::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_SERVER_CLIENT_SEND_KILL_SCORE::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_NETWORK_PACKET_ACK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_CLIENT_SERVER_CONNECTED_ACK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			}
			// end root.PE.Events
			pLuaEnv->EndRegistrationTable();

			pLuaEnv->StartRegistrationTable("Ghosts");
			// start root.PE.Ghosts
			{
				PE::Ghosts::Ghost::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Ghosts::Ghost_SOLDIERS::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			}
			// end root.PE.Ghosts
			pLuaEnv->EndRegistrationTable();
		}
