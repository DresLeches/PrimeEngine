...
struct AABB {
	PrimitiveTypes::Float32 minX;
	PrimitiveTypes::Float32 maxX;
	PrimitiveTypes::Float32 minY;
	PrimitiveTypes::Float32 maxY;
	PrimitiveTypes::Float32 minZ;
	PrimitiveTypes::Float32 maxZ;
};
...
{
	PrimitiveTypes::Float32 yOffset;
