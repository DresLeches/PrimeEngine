...
struct RootSceneNode : public SceneNode
{
	...
	std::vector<PE::Components::SceneNode*> m_meshSNs;
	std::vector<PE::Components::SceneNode*> m_playerSNs;
	std::vector<Vector3*> m_playerVelocities;
...
private:
	...
	Matrix4x4 prevViewProjMatrix = Matrix4x4();
};
