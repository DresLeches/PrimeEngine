...
WinApplication::WinApplication(PE::GameContext &context, unsigned int width, unsigned int height, const char *caption)
{
	...
	UINT64 flags = WS_POPUP | WS_MAXIMIZE | WS_SYSMENU | WS_VISIBLE;
	
#if 1
	flags |= WS_CAPTION | WS_MAXIMIZE | WS_MAXIMIZEBOX | WS_MINIMIZEBOX | WS_SIZEBOX;
#endif

	m_windowHandle = CreateWindowA("D3DWndClassName_PrimeEngine", caption, 
										flags, CW_USEDEFAULT, CW_USEDEFAULT, winWindowWidth, winWindowHeight, 0, 0, hInstance, this);
	if( !m_windowHandle )
	{
