...
struct ConnectionManager : public Component
{
	...
	enum EConnectionManagerState
	{
		...
		ConnectionManagerState_ReceiveOnly
	};
	...
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_ACTIVATE_PACKET_LOSS);
	virtual void do_ACTIVATE_PACKET_LOSS(Events::Event *pEvt);

	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_DEACTIVATE_PACKET_LOSS);
	virtual void do_DEACTIVATE_PACKET_LOSS(Events::Event *pEvt);
