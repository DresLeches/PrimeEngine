...
struct StreamManager : public Component
{
	...
	void receiveAckPacket(char* pDataStream, int& read);

	void processNotification(bool delivered, int needEvtNum);
	...
	static int WriteInt16(PrimitiveTypes::Int16 v, char *pDataStream);
	static int ReadInt16(char *pDataStream, PrimitiveTypes::Int16 &out_v);
