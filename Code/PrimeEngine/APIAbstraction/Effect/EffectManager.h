...
struct EffectManager : public PE::PEAllocatableAndDefragmentable
{
	...
	void setTextureAndDepthTextureRenderTargetForZPrePass();
	...
	void coneTrace();
	void ssao();
	void indirectDiffuseLighting();
	void indirectSpecularLighting();
...
public:
	...
	TextureGPU m_LUTTextureGPU;
	TextureGPU m_SkyboxCubemapTextureGPU;
	TextureGPU m_HUDTextureGPU;
	TextureGPU m_DitherTextureGPU;
	TextureGPU m_NoiseTextureGPU;
	...
	Handle m_hVoxelClearEffect;
	Handle m_hVoxelInjectionSetupEffect;
	Handle m_hVoxelInjectionEffect;
	Handle m_hConeTracingEffect;
	Handle m_hSSAOEffect;
	Handle m_hIndirectDiffuseLightingEffect;
	Handle m_hIndirectSpecularLightingEffect;
	Handle m_hVolumetricLightingEffect;
	Handle m_hFXAAEffect;
	Handle m_hToneMappingEffect;
	Handle m_hColorGradingEffect;
	Handle m_hSkyBoxRenderEffect;
	Handle m_hMotionBlurCSEffect;
	Handle m_hHUDRenderEffect;
