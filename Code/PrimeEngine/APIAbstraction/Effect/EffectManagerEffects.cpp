...
namespace PE {
    ...
    void EffectManager::loadDefaultEffects()
    {
		...
		m_LUTTextureGPU.createColorTextureGPU("LUT.dds", "Default");

		m_SkyboxCubemapTextureGPU.createCubeMapTextureGPU("xn.dds", "xp.dds", "yn.dds", "yp.dds", "zn.dds", "zp.dds", "Default");

		m_HUDTextureGPU.createColorTextureGPU("HUDTexture.dds", "Default");

		m_DitherTextureGPU.createColorTextureGPU("DitherTexture.dds", "Default");
		
		m_NoiseTextureGPU.createColorTextureGPU("NoiseTexture.dds", "Default");
...
#else
		PEINFO("PE: PROGRESS: Creating m_shadowMapDepthTexture 4096x4096\n");
		// need to lerp minimization and at this point we dont lerp magnification
		m_shadowMapDepthTexture.createDrawableIntoDepthTexture(4096, 4096, SamplerState_NoMips_MinTexelLerp_NoMagTexelLerp_Clamp);
#endif
	...
	#if PE_API_IS_D3D11
	{
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"VoxelClear_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"VoxelClear_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("VoxelClear_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"VoxelInjectionSetup_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"VoxelInjectionSetup_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("VoxelInjectionSetup_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"VoxelInjection_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"VoxelInjection_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("VoxelInjection_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"SHConeTracing_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"SHConeTracing_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("SHConeTracing_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"SSAO_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"SSAO_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("SSAO_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"IndirectDiffuseLighting_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"IndirectDiffuseLighting_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("IndirectDiffuseLighting_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"IndirectSpecularLighting_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"IndirectSpecularLighting_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("IndirectSpecularLighting_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"VolumetricLighting_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"VolumetricLighting_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("VolumetricLighting_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"FXAA_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"FXAA_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("FXAA_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"ToneMapping_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"ToneMapping_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("ToneMapping_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"ColorGrading_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"ColorGrading_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("ColorGrading_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"SkyBoxRender_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"SkyBoxRender_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("SkyBoxRender_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"MotionBlur_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"MotionBlur_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("MotionBlur_CS_Tech", hEffect);
		}
	#endif
	...
	#if PE_API_IS_D3D11
		{
			...
			pEffect->loadTechnique(
				...
				NULL, NULL, // geometry shader
				NULL, NULL,
				"HUDRender_CS", "main", // compute shader
				PERasterizerState_SolidTriBackCull,
				PEDepthStencilState_ZBuffer, PEAlphaBlendState_NoBlend, // depth stencil, blend states
				"HUDRender_CS_Tech");

			pEffect->m_psInputFamily = EffectPSInputFamily::DETAILED_MESH_PS_IN;
			m_map.add("HUDRender_CS_Tech", hEffect);
		}
	#endif
