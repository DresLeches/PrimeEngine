...
struct TextureGPU : PE::PEAllocatableAndDefragmentable
{
	...
	void createCubeMapTextureGPU(const char * textureFilenameXN, const char * textureFilenameXP, 
								 const char * textureFilenameYN, const char * textureFilenameYP, 
								 const char * textureFilenameZN, const char * textureFilenameZP, 
								 const char *package = NULL, ESamplerState samplerState = SamplerState_Count);
